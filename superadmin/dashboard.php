...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  // Add scent (superadmin and admin)
  if (isset($_POST['add_scent']) && ($currentUserRole === 'superadmin' || $currentUserRole === 'admin')) {
    $name = $_POST['name'] ?? '';
    $description = $_POST['description'] ?? '';
  ...
  // Add type (superadmin and admin)
  if (isset($_POST['add_type']) && ($currentUserRole === 'superadmin' || $currentUserRole === 'admin')) {
    $name = $_POST['name'] ?? '';
    $description = $_POST['description'] ?? '';
  ...
  // Update scent (admin and superadmin)
  if (isset($_POST['update_scent']) && ($currentUserRole === 'superadmin' || $currentUserRole === 'admin')) {
    $id = $_POST['id'] ?? 0;
    $name = $_POST['name'] ?? '';
    $description = $_POST['description'] ?? '';
  ...
  // Update type (admin and superadmin)
  if (isset($_POST['update_type']) && ($currentUserRole === 'superadmin' || $currentUserRole === 'admin')) {
    $id = $_POST['id'] ?? 0;
    $name = $_POST['name'] ?? '';
    $description = $_POST['description'] ?? '';
...
<head>
  ...
  <title>Dashboard Super Admin - Parfumé Lux</title>
...
<body>
  ...
  <div class="admin-sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <?php if ($currentUserRole === 'superadmin' || $currentUserRole === 'admin' || $currentUserRole === 'partnership'): ?>
            ...
            <div class="scent-card">
              ...
              <?php if ($currentUserRole === 'superadmin' || $currentUserRole === 'admin'): ?>
                <div class="card-actions" style="margin-top: 10px;">
                  ...
                  <?php if ($currentUserRole === 'superadmin'): ?>
                    <button class="btn-delete btn-sm" onclick="deleteScent(<?php echo $scent['id']; ?>)" title="Hapus">
                      <i class="ri-delete-bin-line"></i>
                    </button>
                  <?php endif; ?>
                </div>
            ...
            <div class="type-card">
              ...
              <?php if ($currentUserRole === 'superadmin' || $currentUserRole === 'admin'): ?>
                <div class="card-actions" style="margin-top: 10px;">
                  ...
                  <?php if ($currentUserRole === 'superadmin'): ?>
                    <button class="btn-delete btn-sm" onclick="deleteType(<?php echo $type['id']; ?>)" title="Hapus">
                      <i class="ri-delete-bin-line"></i>
                    </button>
                  <?php endif; ?>
                </div>
                ...
                <td>
                  <div class="action-buttons">
                    ...
                    if ($currentUserRole === 'superadmin' || $currentUserRole === 'admin') {
                      ...
                      // Partnership can only edit their own branch (not Toko Pusat)
                      $userBranchId = $_SESSION['branch_id'] ?? null;
                      if ($userBranchId && $store['branch_id'] === $userBranchId && $store['name'] !== 'Toko Pusat') {
                        $canEdit = true;
                      }
                    }
